...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-primary text-text flex">
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 h-screen w-64 bg-secondary/95 backdrop-blur-xl border-r border-border flex flex-col transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto',
      ...
      >
        ...
        <div className="p-3 border-t border-border">
          <button
            ...
            className="flex items-center justify-center gap-3 px-4 py-2.5 w-full rounded-xl text-sm font-medium text-text-secondary hover:text-error hover:bg-error/10 transition-all duration-300"
          >
      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0">
        <header className="h-16 bg-secondary/70 backdrop-blur-xl border-b border-border flex items-center justify-between px-4 md:px-6 sticky top-0 z-30">
          <button
